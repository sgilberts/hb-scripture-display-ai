      ...
      <div className="flex min-h-0 flex-1">
        ...
        <div className="flex min-w-0 flex-1 flex-col gap-px bg-[#3c4a42]">
          ...
          <div className="flex min-h-0 flex-1 gap-px">
            <section className="flex w-52 shrink-0 flex-col gap-px bg-[#3c4a42] overflow-y-auto">
               ...
               <div className="bg-[#1f1f22] flex flex-col p-2 pt-0 shrink-0">
                  <span className="mb-1 block font-mono text-[8px] font-semibold uppercase tracking-[0.1em] text-[#bbcabf]">Lower Third Style</span>
                  <div className="grid grid-cols-2 gap-1">
                     {["CLASSIC", "BANNER", "MINIMAL", "CUSTOM"].map(style => (
                        <button key={style} className={joinClasses("h-6 border border-[#3c4a42] font-mono text-[7px] font-bold uppercase text-[#bbcabf]", style === "CLASSIC" ? "border-[#4edea3] text-[#4edea3]" : "")}>
                           {style}
                        </button>
                     ))}
                  </div>
            ...
            <section className="flex min-w-0 flex-1 flex-col gap-px bg-[#3c4a42]">
                ...
                <div className="flex flex-1 min-h-[15rem] gap-px bg-[#3c4a42]">
                   ...
                   <div className="w-16 bg-[#1f1f22] flex flex-col items-center p-1 gap-0.5 shrink-0 border-l border-[#3c4a42]">
                    ...
                    <div className="flex flex-1 min-h-0 gap-px bg-[#3c4a42]">
